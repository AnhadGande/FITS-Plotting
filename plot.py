...
class Plot():
    ...
    def __init__(self, filename, filetwo=None, xmin=None, xmax=None, ymin=None, ymax=None, showimage=True, ned=None,
                 saveplot=False,
                 smo=None,
                 h=False):
    ...
    def plot(self, xmin, xmax, ymin, ymax, saveplot):
        ...
        if self.file_two is not None:
            ...
            if self.run is True:
                signal1 = self.smooth(self.file_two)
...
if __name__ == '__main__':
    ...
    #     print(args.l)
    Plot(args.filename, args.ftwo, args.xmin, args.xmax, args.ymin, args.ymax, smo=args.smo, showimage=args.showimage,
